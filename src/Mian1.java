...
public class Mian1 {
	...
	public static void main(String[] args) {
	    ...
	    while (!salir) {
	    	...
	    	System.out.println("  |                                            |");
	    	System.out.println("  | 1. Crear perfil de jugador (si eres nuevo) |");
	    	System.out.println("  | 2. Cargar perfil de jugador (existente)    |");
        	    ...
        	    private static PerfilJugador cargarPerfil(String nombre) {
        	        try {
        	            ...
        	            if (file.exists()) {
        	                ...
        	                System.out.println("El perfil del jugador no existe.");
        	            }
